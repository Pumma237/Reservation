...
--
-- Hôte : 127.0.0.1
-- Généré le :  ven. 17 août 2018 à 15:59
...
INSERT INTO `user` (`id`, `login`, `mdp`, `Nom`, `isAdmin`, `isAdherent`) VALUES
(1, 'Ivan', 777, 'Ivan Taranov', 1, 0),
(4, 'Test2', 12345, 'Test2 Test', 0, 0),
(6, 'Rpmain', 0, 'Romain Kiro', 0, 2);
